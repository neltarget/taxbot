    ...
    <div className="flex justify-start items-end gap-2.5 animate-fade-in" role="status" aria-label="TaxBot is typing a response">
      ...
      <div className="flex flex-col">
        ...
        <div className="rounded-2xl px-4 py-2.5 bg-white/[0.03] border border-white/[0.04] flex items-center gap-1">
          <span className="animate-dot-bounce w-1.5 h-1.5 rounded-full bg-amber-500/50 inline-block" style={{ animationDelay: '0ms' }} />
          <span className="animate-dot-bounce w-1.5 h-1.5 rounded-full bg-amber-500/50 inline-block" style={{ animationDelay: '150ms' }} />
          <span className="animate-dot-bounce w-1.5 h-1.5 rounded-full bg-amber-500/50 inline-block" style={{ animationDelay: '300ms' }} />
        </div>
